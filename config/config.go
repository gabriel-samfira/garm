...
type Config struct {
	...
	EmbededEtcd EmbededEtcd `toml:"embeded_etcd" json:"embeded-etcd"`
}
...
func (c *Config) Validate() error {
	...
	if err := c.EmbededEtcd.Validate(); err != nil {
		return errors.Wrap(err, "validating embeded etcd config")
	}
...
type EmbededEtcd struct {
	...
	ClientTLSInfo            EtcdTLSInfo `toml:"client_tls"`
}
...
func (e *EmbededEtcd) ServerConfig(baseDir string) (*embed.Config, error) {
	...
	cfg.ClientTLSInfo, err = e.ClientTLSInfo.TLSInfo()
	if err != nil {
...
func (e *EtcdTLSInfo) TLSInfo() (transport.TLSInfo, error) {
	...
	return transport.TLSInfo{
		ClientCertFile: e.CertPath,
		ClientKeyFile:  e.KeyPath,

...
func (h *EndpointsHandler) ListEndpointsHandler(w http.ResponseWriter, r *http.Request) {
	...
	if len(endpoints) == 0 {
		emptyData := EmptyTableRowData{
			ColSpan: 6,
			Icon: template.HTML(`<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-9m0-9v9"></path>`),
			Message:    "No endpoints configured",
			SubMessage: "Add an endpoint to get started",
		}
...
func (h *EndpointsHandler) CreateEndpointHandler(w http.ResponseWriter, r *http.Request) {
	...
	switch params.EndpointType(endpointType) {

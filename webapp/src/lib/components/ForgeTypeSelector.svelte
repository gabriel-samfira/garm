...
<div>
	...
	<div class="grid grid-cols-2 gap-4">
		<button
			...
			class="flex flex-col items-center justify-center p-6 border-2 rounded-lg transition-colors {selectedForgeType === 'github' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900' : 'border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500'}"
		>
			{@html getForgeIcon('github')}
			<span class="mt-2 text-sm font-medium text-gray-900 dark:text-white">GitHub</span>
		</button>
		<button
			type="button"
			on:click={() => selectForgeType('gitea')}
			class="flex flex-col items-center justify-center p-6 border-2 rounded-lg transition-colors {selectedForgeType === 'gitea' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900' : 'border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500'}"
		>
			{@html getForgeIcon('gitea')}

<script lang="ts">
	...
	import type { CreateEnterpriseParams, ForgeCredentials, Endpoint, PoolBalancerType } from '$lib/api/types.js';
		...
		{:else}
			<form on:submit|preventDefault={handleSubmit} class="space-y-4">
				...
				<div class="flex justify-end space-x-3 pt-4">
					...
					<button
						type="submit"
						disabled={loading || !isFormValid || filteredCredentials.length === 0}

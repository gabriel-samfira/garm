<script lang="ts">
	...
	import type { Organization, UpdateEntityParams, ForgeCredentials } from '$lib/api/types.js';
...
<Modal on:close={() => dispatch('close')}>
	<div class="p-6">
		<h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Update Organization</h3>
		<p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
			Updating: <span class="font-medium">{organization.name}</span>
		</p>

...
------------ | ------------- | ------------- | -------------
**desired_runner_count** | **number** |  | [optional] [default to undefined]
...
**status_messages** | [**Array&lt;StatusMessage&gt;**](StatusMessage.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ScaleSet } from './api';

const instance: ScaleSet = {

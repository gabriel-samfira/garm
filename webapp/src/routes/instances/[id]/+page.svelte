				...
				<div class="flex items-center justify-between mb-4">
					...
					<div class="flex items-center space-x-3">
						...
						<button
							...
							class="px-4 py-2 bg-red-600 hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-800 text-white rounded-lg font-medium text-sm"
						>
							Delete Instance
						</button>
					</div>
			...
			<div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
				...
				<dl class="space-y-3">
					<div class="flex justify-between items-center">
						...
						<dd class="text-sm">
							<span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full ring-1 ring-inset {getStatusBadgeClass(instance.status)}">
								{instance.status}
							</span>
						</dd>
					</div>
					<div class="flex justify-between items-center">
						...
						<dd class="text-sm">
							<span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full ring-1 ring-inset {getStatusBadgeClass(instance.runner_status)}">
					...
					<div class="flex justify-between items-start">
						...
						<div class="flex items-center space-x-2 flex-shrink-0">
							...
							<span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full 
								{message.event_level === 'error' ? 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200' :
								message.event_level === 'warning' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200' :
